...
console.log('\x1b[0m%s\x1b[31m%s\x1b[0m' , "sendTransaction sendCoin( " + process.argv[2] + "," , process.argv[3] , ")");
myContract.sendCoin(process.argv[2], process.argv[3], {from:address ,gas: 100000}, function(err, boolean) {
    if (err) {
        console.log("Transaction err:"+err); // 
    } else {
        console.log("Transaction :"+boolean); 
    }
} );